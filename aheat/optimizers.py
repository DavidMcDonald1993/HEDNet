...
from tensorflow.train import AdamOptimizer, MomentumOptimizer, RMSPropOptimizer, GradientDescentOptimizer
...
class ExponentialMappingOptimizer(optimizer.Optimizer):
	...
	def __init__(self, 
		...
		# self.euclidean_optimizer = MomentumOptimizer(0.01, 0.01)
...
class MyAdamOptimizer(optimizer.Optimizer):
  ...
  def _apply_sparse_shared(self, grad, var, indices, scatter_add):
    ...
    if "hyperbolic" in var.name:
        grad = K.concatenate([grad[:,:-1], -grad[:,-1:]], axis=-1)
